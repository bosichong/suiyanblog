...
export const SITE_DESCRIPTION = '技术文章留给搜索引擎，余下的留给懂的人——这里，是一个普通人的碎言。';
export const SITE_DESCRIPTION_EN = 'You see see you , This one day day di.';
export const SITE_AUTHOR = 'J.sky';
export const ABOUT_ME = '技术文章留给搜索引擎，余下的留给懂的人——这里，是一个普通人的碎言。';
export const META_DESCRIPTION = '技术文章留给搜索引擎，余下的留给懂的人——这里，是一个普通人的碎言。';
