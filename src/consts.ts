...
export const SITE_DESCRIPTION = '坚持深度阅读，持续写作输出，把固执与坚持，用在值得的事情上。';
export const SITE_DESCRIPTION_EN = 'You see see you , This one day day di.';
export const SITE_AUTHOR = 'J.sky';
export const ABOUT_ME = '坚持深度阅读，持续写作输出，把固执与坚持，用在值得的事情上。';
export const META_DESCRIPTION = '坚持深度阅读，持续写作输出，复盘技术实践。以终生学习对抗不确定性，把固执与坚持，All in 在值得的事情上。';
