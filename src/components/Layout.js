...
const Layout = ({ children }) => {
    ...
    return (
        ...
        <div className={'flex h-full flex-col items-center justify-start font-sans md:relative md:flex-row md:items-start md:justify-center'}>
                    ...
                    {config.menuItems.map((item, index) => (
                        ...
                        >
                            <Link
                                className={
                                    index === randomIndex
                                        ? "w-full motion-preset-seesaw hover:animate-none flex justify-center" // 添加这一行
                                        : "w-full hover:motion-preset-shake flex justify-center" // 添加这一行
                                }
                                href={`${item.href}`}
                                size="md"
                            >
            ...
            <main className={'w-full px-2 leading-normal font-extralight md:max-w-4xl'}>
                {children}
                <Footer/>
            </main>
